...
sys.path.append(os.path.join(os.path.dirname("__file__"), '..', '..'))
from pytorch_net.util import str2bool
...
def arg_parse():
    ...
    parser.add_argument('--evo_transfer', type=str2bool, nargs='?', const=True, default=False,
                        help="If True, adopt transfer learning")
    ...
    parser.add_argument('--load_hash_filename', type=str,
                        help='Filename to load previous experiment from.')
    ...
    parser.add_argument('--stress', type=str2bool, nargs='?', const=True,
                        help="If True, predicted the stress field.")
