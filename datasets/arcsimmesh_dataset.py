...
sys.path.append(os.path.join(os.path.dirname("__file__"), '..', '..'))
sys.path.append(os.path.join(os.path.dirname("__file__"), '..', '..', '..'))
from utils import PDE_PATH, ARCSIMMESH_PATH
...
class ArcsimMesh(Dataset):
    ...
    def yield_f_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        ...
        xfaces = np.load(file_name)['xfaces']
        return xfaces
    ...
    def yield_v_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        ...
        if not dataset == "arcsimmesh_square":
            ...
            file_name = os.path.join(self.processed_dir, "traj_{:06d}/{:04d}_00.npz".format(traj_id, time_id))
        xworldp = np.load(file_name)['xworldp']
        return xworldp
    ...
    def yield_ny_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        ...
        if not dataset == "arcsimmesh_square":
            ...
            file_name = os.path.join(self.processed_dir, "traj_{:06d}/{:04d}_00.npz".format(traj_id, time_id))
        xmeshp = np.load(file_name)['xmeshp']
        return xmeshp
    ...
    def yield_ns_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        """ Generate stress filed of 2d mesh as 3d subspace.
        Args:
            traj_id: index of trajectory folder.
            time_id: index of time step.
        ...
        if not dataset == "arcsimmesh_square":
            ...
            file_name = os.path.join(self.processed_dir, "traj_{:06d}/{:04d}_00.npz".format(traj_id, time_id))
        stress = np.load(file_name)['stress']
        return stress

    def yield_edge_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        """ Generate edge index.
        Args:
            traj_id: index of trajectory folder.
            time_id: index of time step.
    ...
    def get_stress_file(self, traj_id, time_id, dataset="arcsimmesh_square"):
        """ Generate numpy array of stress filed as 2d supspace in 3d space.
        Args:
            traj_id: index of trajectory folder.
            time_id: index of time step.
    ...
    def get(self, idx):
        ...
        stress_symlog = []
        if self.stress:
            for i in range(len(ystress_list)):
                # pdb.set_trace()
                stress_symlog.append(np.sign(ymeshp_list[i]) * np.log(np.abs(ymeshp_list[i]) + 1))
        ...
        data = Attr_Dict(
            ...
            yfeatures_space={"n0": tuple(ystress_list),},
            reind_yfeatures_space={"n0": tuple(ystress_list),},
            ...
            y_back_space = {"n0": tuple(stress_symlog)},
...
def get_2d_data_pred(state_preds, step, data, **kwargs):
    ...
    data_pred = Attr_Dict(
        ...
        yface_list_finegrain={"n0": data["yface_list_finegrain"]["n0"]},
        history={"n0": data["history"]["n0"],},
        history_stress={"n0": data["history_stress"]["n0"],},
        yfeatures={"n0": data["yfeatures"]["n0"],},
        yfeatures_finegrain={"n0": data["yfeatures_finegrain"]["n0"],},
        yfeatures_stress={"n0": data["yfeatures_stress"]["n0"],},
        yfeatures_stress_finegrain={"n0": data["yfeatures_stress_finegrain"]["n0"],},
        node_dim={"n0": data["node_dim"]["n0"],},
        xface_list={"n0": data["xface_list"]["n0"],},
        reind_yfeatures={"n0": data["reind_yfeatures"]["n0"],},
        reind_yfeatures_finegrain={"n0": data["reind_yfeatures_finegrain"]["n0"],},
        reind_yfeatures_stress={"n0": data["reind_yfeatures_stress"]["n0"],},        
        reind_yfeatures_stress_finegrain={"n0": data["reind_yfeatures_stress_finegrain"]["n0"],},
