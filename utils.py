...
sys.path.append(os.path.join(os.path.dirname("__file__"), '..', '..'))
from pytorch_net.util import lcm, L2Loss, Attr_Dict, Printer, zero_grad_hook_multi, get_triu_block, get_tril_block, My_Tuple
...
TETRAMESH_PATH = 'tetramesh_beam_data/'
FNO_PATH = "fno_data/"
                ...
                for key in elem:
                    if key == "node_feature":
                        ...
                        for i in range(len(batch_nodes)):
                            ...
                            Dict["batch"]["n0"].append(item)
                        Dict["batch"]["n0"] = torch.cat(Dict["batch"]["n0"])
                    elif key in ["y_tar","y_tar_stress" "reind_yfeatures","reind_yfeatures_stress"]:
                        # pdb.set_trace()
...
def attrdict_to_pygdict(attrdict, is_flatten=False, use_pos=False):    
    pygdict = {
        ...
        "stress":attrdict["node_stress"]["n0"],
    ...
    if len(dict(to_tuple_shape(attrdict["original_shape"]))["n0"]) == 0:
        ...
        pygdict["y_back_stress"] = attrdict["y_back_stress"]["n0"]
        pygdict["y_tar"] = attrdict["y_tar"]["n0"]
        pygdict["y_tar_stress"] = attrdict["y_tar_stress"]["n0"]
        pygdict["yface_list"] = attrdict["yface_list"]["n0"]
        pygdict["history"] = attrdict["history"]["n0"]
        pygdict["history_stress"] = attrdict["history_stress"]["n0"]
        pygdict["yfeatures"] = attrdict["yfeatures"]["n0"]
        pygdict["yfeatures_stress"] = attrdict["yfeatures_stress"]["n0"]
        ...
        pygdict["reind_yfeatures_stress"] = attrdict["reind_yfeatures_stress"]["n0"]
